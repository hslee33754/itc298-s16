...
var matchedItem = function(userKeyword){
    var isMatched = function(obj){
        var title = String(obj.title).toLowerCase();
...
exports.getMatchedItem = function(userInput){
    ...
    getInput = userInput; //save user input to use it in other functions
    return books[idx];
};
